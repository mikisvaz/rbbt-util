...
1 - install rvm: https://rvm.beginrescueend.com/ (will need git and curl installed)
    ...
    echo '[[ -s "$HOME/.rvm/scripts/rvm" ]] && . "$HOME/.rvm/scripts/rvm"' >> tmp.bashrc
...
2 - install tokyocabinet (Intructions for user install follow. For system level, make sure we have dev package)
    ...
    echo "export LD_RUN_PATH='$LD_RUN_PATH:$HOME/software/opt/tokyocabinet/lib'" >> tmp.profile
    echo "export LD_LIBRARY_PATH='$LD_LIBRARY_PATH:$HOME/software/opt/tokyocabinet/lib'" >> tmp.profile
    echo "export PATH='$PATH:$HOME/software/opt/tokyocabinet/bin'" >> tmp.profile
