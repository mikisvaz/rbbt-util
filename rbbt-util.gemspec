...
# -*- encoding: utf-8 -*-
# stub: rbbt-util 5.20.23 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_helper.rb", "test/rbbt/resource/test_path.rb", "test/rbbt/association/test_item.rb", "test/rbbt/association/test_database.rb", "test/rbbt/association/test_open.rb", "test/rbbt/association/test_index.rb", "test/rbbt/association/test_util.rb", "test/rbbt/util/test_concurrency.rb", "test/rbbt/util/test_log.rb", "test/rbbt/util/test_chain_methods.rb", "test/rbbt/util/test_simpleopt.rb", "test/rbbt/util/simpleopt/test_parse.rb", "test/rbbt/util/simpleopt/test_get.rb", "test/rbbt/util/simpleopt/test_setup.rb", "test/rbbt/util/test_cmd.rb", "test/rbbt/util/test_semaphore.rb", "test/rbbt/util/concurrency/test_threads.rb", "test/rbbt/util/concurrency/processes/test_socket.rb", "test/rbbt/util/concurrency/test_processes.rb", "test/rbbt/util/test_tmpfile.rb", "test/rbbt/util/test_open.rb", "test/rbbt/util/test_filecache.rb", "test/rbbt/util/R/test_eval.rb", "test/rbbt/util/R/test_model.rb", "test/rbbt/util/test_simpleDSL.rb", "test/rbbt/util/log/test_progress.rb", "test/rbbt/util/test_colorize.rb", "test/rbbt/util/test_R.rb", "test/rbbt/util/misc/test_lock.rb", "test/rbbt/util/misc/test_pipes.rb", "test/rbbt/util/misc/test_bgzf.rb", "test/rbbt/util/misc/test_omics.rb", "test/rbbt/util/misc/test_multipart_payload.rb", "test/rbbt/util/test_excel2tsv.rb", "test/rbbt/util/test_misc.rb", "test/rbbt/test_entity.rb", "test/rbbt/workflow/step/test_dependencies.rb", "test/rbbt/workflow/test_doc.rb", "test/rbbt/workflow/test_step.rb", "test/rbbt/workflow/test_task.rb", "test/rbbt/test_association.rb", "test/rbbt/test_knowledge_base.rb", "test/rbbt/tsv/parallel/test_traverse.rb", "test/rbbt/tsv/parallel/test_through.rb", "test/rbbt/tsv/test_parallel.rb", "test/rbbt/tsv/test_accessor.rb", "test/rbbt/tsv/test_change_id.rb", "test/rbbt/tsv/test_stream.rb", "test/rbbt/tsv/test_filter.rb", "test/rbbt/tsv/test_matrix.rb", "test/rbbt/tsv/test_attach.rb", "test/rbbt/tsv/test_manipulate.rb", "test/rbbt/tsv/test_field_index.rb", "test/rbbt/tsv/test_index.rb", "test/rbbt/tsv/test_util.rb", "test/rbbt/tsv/test_parser.rb", "test/rbbt/test_packed_index.rb", "test/rbbt/test_persist.rb", "test/rbbt/test_fix_width_table.rb", "test/rbbt/knowledge_base/test_traverse.rb", "test/rbbt/knowledge_base/test_entity.rb", "test/rbbt/knowledge_base/test_query.rb", "test/rbbt/knowledge_base/test_enrichment.rb", "test/rbbt/knowledge_base/test_syndicate.rb", "test/rbbt/knowledge_base/test_registry.rb", "test/rbbt/entity/test_identifiers.rb", "test/rbbt/test_monitor.rb", "test/rbbt/test_workflow.rb", "test/rbbt/test_annotations.rb", "test/rbbt/annotations/test_util.rb", "test/rbbt/test_resource.rb", "test/rbbt/persist/tsv/test_tokyocabinet.rb", "test/rbbt/persist/tsv/test_kyotocabinet.rb", "test/rbbt/persist/tsv/test_lmdb.rb", "test/rbbt/persist/tsv/test_leveldb.rb", "test/rbbt/persist/tsv/test_cdb.rb", "test/rbbt/persist/tsv/test_sharder.rb", "test/rbbt/persist/test_tsv.rb", "test/rbbt/test_tsv.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<to_regexp>, [">= 0"])
      s.add_runtime_dependency(%q<nakayoshi_fork>, [">= 0"])
    else
      ...
      s.add_dependency(%q<to_regexp>, [">= 0"])
      s.add_dependency(%q<nakayoshi_fork>, [">= 0"])
    end
  else
    s.add_dependency(%q<rake>, [">= 0"])
    s.add_dependency(%q<progress-monitor>, [">= 0"])
