...
# -*- encoding: utf-8 -*-
# stub: rbbt-util 5.26.92 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_helper.rb".freeze, "test/rbbt/test_annotations.rb".freeze, "test/rbbt/association/test_database.rb".freeze, "test/rbbt/association/test_item.rb".freeze, "test/rbbt/association/test_index.rb".freeze, "test/rbbt/association/test_open.rb".freeze, "test/rbbt/association/test_util.rb".freeze, "test/rbbt/test_association.rb".freeze, "test/rbbt/knowledge_base/test_syndicate.rb".freeze, "test/rbbt/knowledge_base/test_enrichment.rb".freeze, "test/rbbt/knowledge_base/test_query.rb".freeze, "test/rbbt/knowledge_base/test_entity.rb".freeze, "test/rbbt/knowledge_base/test_registry.rb".freeze, "test/rbbt/knowledge_base/test_traverse.rb".freeze, "test/rbbt/util/test_config.rb".freeze, "test/rbbt/util/test_R.rb".freeze, "test/rbbt/util/test_tmpfile.rb".freeze, "test/rbbt/util/test_filecache.rb".freeze, "test/rbbt/util/test_misc.rb".freeze, "test/rbbt/util/test_excel2tsv.rb".freeze, "test/rbbt/util/log/test_progress.rb".freeze, "test/rbbt/util/misc/test_multipart_payload.rb".freeze, "test/rbbt/util/misc/test_pipes.rb".freeze, "test/rbbt/util/misc/test_bgzf.rb".freeze, "test/rbbt/util/misc/test_lock.rb".freeze, "test/rbbt/util/misc/test_omics.rb".freeze, "test/rbbt/util/test_semaphore.rb".freeze, "test/rbbt/util/simpleopt/test_get.rb".freeze, "test/rbbt/util/simpleopt/test_parse.rb".freeze, "test/rbbt/util/simpleopt/test_setup.rb".freeze, "test/rbbt/util/test_open.rb".freeze, "test/rbbt/util/concurrency/test_processes.rb".freeze, "test/rbbt/util/concurrency/test_threads.rb".freeze, "test/rbbt/util/concurrency/processes/test_socket.rb".freeze, "test/rbbt/util/test_log.rb".freeze, "test/rbbt/util/test_colorize.rb".freeze, "test/rbbt/util/test_cmd.rb".freeze, "test/rbbt/util/test_concurrency.rb".freeze, "test/rbbt/util/R/test_eval.rb".freeze, "test/rbbt/util/R/test_plot.rb".freeze, "test/rbbt/util/R/test_model.rb".freeze, "test/rbbt/util/test_simpleopt.rb".freeze, "test/rbbt/util/test_chain_methods.rb".freeze, "test/rbbt/util/test_simpleDSL.rb".freeze, "test/rbbt/util/test_python.rb".freeze, "test/rbbt/tsv/test_index.rb".freeze, "test/rbbt/tsv/test_parser.rb".freeze, "test/rbbt/tsv/test_field_index.rb".freeze, "test/rbbt/tsv/test_stream.rb".freeze, "test/rbbt/tsv/test_accessor.rb".freeze, "test/rbbt/tsv/test_change_id.rb".freeze, "test/rbbt/tsv/test_parallel.rb".freeze, "test/rbbt/tsv/parallel/test_through.rb".freeze, "test/rbbt/tsv/parallel/test_traverse.rb".freeze, "test/rbbt/tsv/test_manipulate.rb".freeze, "test/rbbt/tsv/test_filter.rb".freeze, "test/rbbt/tsv/test_matrix.rb".freeze, "test/rbbt/tsv/test_util.rb".freeze, "test/rbbt/tsv/test_attach.rb".freeze, "test/rbbt/tsv/test_excel.rb".freeze, "test/rbbt/test_monitor.rb".freeze, "test/rbbt/test_workflow.rb".freeze, "test/rbbt/test_hpc.rb".freeze, "test/rbbt/annotations/test_util.rb".freeze, "test/rbbt/test_packed_index.rb".freeze, "test/rbbt/workflow/test_task.rb".freeze, "test/rbbt/workflow/test_doc.rb".freeze, "test/rbbt/workflow/remote/test_client.rb".freeze, "test/rbbt/workflow/test_step.rb".freeze, "test/rbbt/workflow/step/test_dependencies.rb".freeze, "test/rbbt/entity/test_identifiers.rb".freeze, "test/rbbt/test_entity.rb".freeze, "test/rbbt/test_resource.rb".freeze, "test/rbbt/test_persist.rb".freeze, "test/rbbt/persist/tsv/test_tokyocabinet.rb".freeze, "test/rbbt/persist/tsv/test_cdb.rb".freeze, "test/rbbt/persist/tsv/test_leveldb.rb".freeze, "test/rbbt/persist/tsv/test_kyotocabinet.rb".freeze, "test/rbbt/persist/tsv/test_sharder.rb".freeze, "test/rbbt/persist/tsv/test_lmdb.rb".freeze, "test/rbbt/persist/test_tsv.rb".freeze, "test/rbbt/test_tsv.rb".freeze, "test/rbbt/test_fix_width_table.rb".freeze, "test/rbbt/test_knowledge_base.rb".freeze, "test/rbbt/resource/test_path.rb".freeze]
