...
# -*- encoding: utf-8 -*-
# stub: rbbt-util 5.6.12 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/rbbt/test_workflow.rb", "test/rbbt/resource/test_path.rb", "test/rbbt/util/test_cmd.rb", "test/rbbt/util/simpleopt/test_get.rb", "test/rbbt/util/simpleopt/test_parse.rb", "test/rbbt/util/test_chain_methods.rb", "test/rbbt/util/test_simpleDSL.rb", "test/rbbt/util/test_log.rb", "test/rbbt/util/test_open.rb", "test/rbbt/util/test_R.rb", "test/rbbt/util/test_colorize.rb", "test/rbbt/util/test_simpleopt.rb", "test/rbbt/util/test_excel2tsv.rb", "test/rbbt/util/test_filecache.rb", "test/rbbt/util/test_semaphore.rb", "test/rbbt/util/test_misc.rb", "test/rbbt/util/test_tmpfile.rb", "test/rbbt/test_association.rb", "test/rbbt/test_resource.rb", "test/rbbt/test_entity.rb", "test/rbbt/test_knowledge_base.rb", "test/rbbt/association/test_index.rb", "test/rbbt/association/test_item.rb", "test/rbbt/test_tsv.rb", "test/rbbt/workflow/test_task.rb", "test/rbbt/workflow/test_step.rb", "test/rbbt/test_persist.rb", "test/rbbt/test_annotations.rb", "test/rbbt/persist/test_tsv.rb", "test/rbbt/persist/tsv/test_lmdb.rb", "test/rbbt/persist/tsv/test_kyotocabinet.rb", "test/rbbt/persist/tsv/test_cdb.rb", "test/rbbt/persist/tsv/test_tokyocabinet.rb", "test/rbbt/persist/tsv/test_leveldb.rb", "test/rbbt/tsv/test_field_index.rb", "test/rbbt/tsv/test_index.rb", "test/rbbt/tsv/test_change_id.rb", "test/rbbt/tsv/test_util.rb", "test/rbbt/tsv/test_accessor.rb", "test/rbbt/tsv/test_filter.rb", "test/rbbt/tsv/test_attach.rb", "test/rbbt/tsv/test_manipulate.rb", "test/rbbt/test_fix_width_table.rb", "test/test_helper.rb"]
