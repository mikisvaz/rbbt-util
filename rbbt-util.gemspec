...
# -*- encoding: utf-8 -*-
# stub: rbbt-util 5.40.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<net>.freeze, [">= 0"])
    ...
    s.add_dependency(%q<net>.freeze, [">= 0"])
